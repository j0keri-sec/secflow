// Package grabber provides a base implementation for go-rod based crawlers.
package vulngrabber
...
// RodCrawler provides a base implementation for go-rod based crawlers.
...
func (r *RodCrawler) NavigateWithContext(ctx context.Context, page *rod.Page, url string) error {
	return rodutil.NavigateWithContext(ctx, page, url, "")
}
